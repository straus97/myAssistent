...
**СЛЕДУЮЩИЙ ШАГ - PAPER TRADING 7 ДНЕЙ (ТЕКУЩИЙ ПРИОРИТЕТ):**
- 🎯 **Дни 1-3:** Ручной режим EMA Crossover
  - Получать сигналы через `check_paper_trading.ps1` или API
  - Исполнять лучшие сигналы вручную
  - Наблюдать производительность
- 🎯 **Дни 4-7:** Автоматический режим
  - Включить auto-execute
  - Мониторить результаты
  - Оценить финальный Sharpe ratio
- 📊 **Цель:** Sharpe >1.0, Drawdown <10%
- ⏰ **После 7 дней:** Если успешно → реальная торговля (начать с 1000 ₽)
