...
def main():
    ...
    # Вычисляем дату 6 месяцев назад (для максимального улучшения модели)
    ...
    print(f"   Expected: ~4320 candles (180 days x 24h)\n")
    ...
    try:
        ...
        current_since = since
        iteration = 0
        max_iterations = 10  # Максимум 10 запросов (для 6 месяцев)
